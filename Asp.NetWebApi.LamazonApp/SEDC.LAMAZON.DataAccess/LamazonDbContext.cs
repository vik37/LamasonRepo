    ...
    public class LamazonDbContext : IdentityDbContext<User>
    {
        ...
        public void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>()
                ...
                new Product() { Id = 9, Name = "Glasses set", Price = 10, Description = "Set of 6 glasses", Category = CategoryType.Others },
                new Product() { Id = 10, Name = "Plastic knives and forks", Price = 4, Description = "Set of 20 plastic knives and forks", Category = CategoryType.Others },
                new Product() { Id = 11, Name = "Ice", Price = 3, Description = "A bag of ice", Category = CategoryType.Others },
                new Product() { Id = 12, Name = "Plastic plates", Price = 5, Description = "Plates for the whole family", Category = CategoryType.Others }
                );
        }
